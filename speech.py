...
class Speech(GstSpeechPlayer):
    ...
    def set_kokoro_voice(self, voice_name): #TODO - function set here to this can be called for when switching happens via GUI
    ...
    def get_available_kokoro_voices(self): #TODO - function set here to this can be called for when retreiving happens via GUI
